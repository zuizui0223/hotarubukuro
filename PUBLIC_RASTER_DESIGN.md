# Horticultural public-raster design (locked v10)
...
| Axis | Ecological construct | Operational variable in v10 | Inferential role |
|---|---|---|---|
...
v10 definitions after inspecting the current response.
