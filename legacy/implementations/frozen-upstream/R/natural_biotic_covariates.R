...
#
# This module is loaded after R/environment_spatial.R. It does not replace the
...
if (length(missing_base_functions)) {
  stop(
    "Load R/environment_spatial.R before natural_biotic_covariates.R. Missing: ",
...
run_natural_biotic_covariates <- function(analysis_data_csv, occurrence_dir, output_dir,
                                        raw_colour_csv = "",
                                        radii_km = c(50, 100),
  ...
  summary_values <- list(
    pipeline = "natural_biotic_covariates",
