...
The PR #62 CI fixes change only artifact restoration and validation contracts; they do not change any accepted scientific estimate, comparison, or interpretation above. The final rerun after those fixes is likewise validation-only and must leave every locked value unchanged.
