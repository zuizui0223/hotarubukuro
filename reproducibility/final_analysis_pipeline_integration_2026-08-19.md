# Final analysis-pipeline manuscript integration
...
6. ホタルブクロ and ヤマホタルブクロ pooled as *Campanula punctata* sensu lato in the image analysis because their diagnostic distinction is concentrated in calyx morphology and preliminary unpublished data show no clear genetic differentiation. This is an analytical scope decision, not a taxonomic revision.
...
- Local Bombus: 67 pairs; mean +0.03590; median -0.00277; 49.3% positive; q=0.0815.
...
The paper does not claim selection, local adaptation, realized pollination, horticultural origin, planting, escape, plasticity or gene flow. The supported-term test is a direct comparison with fitted spatial continuity, and continuous isolation is an explicitly post hoc analysis with frozen density and natural-map guardrails.