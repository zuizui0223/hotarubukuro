...
script_path <- if (length(file_arg)) sub("^--file=", "", file_arg[1]) else "scripts/run_ecological_analysis_v2.R"
...
cat("Completed ecological analysis v2: ", normalizePath(output_dir, winslash = "/"), "\n", sep = "")
