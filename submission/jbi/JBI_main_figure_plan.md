...
- (a) YAMAP photo -> author check -> colour extraction -> two responses;
- (b) 1,922 observations across Japan;
...
- (a) final environmental coefficients;
- (b) cross-fitted pigmentation probability;
...
- (a) 67 fixed white-pigmented pairs within 5 km;
