...
The all-cell isolation analysis was developed after inspection of preliminary human-context patterns and is therefore explicitly post hoc rather than a preregistered third prediction. Its frozen guardrail question is narrower: are pigmented occurrences that lie farther from other pigmented occurrences more population-exposed than expected from the fitted natural flower-colour geography, and does that result survive local sampling-density correction?
