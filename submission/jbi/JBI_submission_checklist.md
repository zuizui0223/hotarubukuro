...
Checked against the current Wiley `Journal of Biogeography` Author Guidelines on 2026-08-09.
...
- Remove author names, affiliations, acknowledgements and identifying repository links from the main manuscript.
...
- Supply Supporting Information separately.
...
- Cover letter prepared separately. Current Wiley page describes it as optional; a concise JBI-specific letter is nevertheless ready.
...
- Author Contributions: finalize with all co-authors; keep names out of the anonymized file.
- Funding/Acknowledgements: finalize with co-authors and place only in the identifying title-page/submission materials until anonymity requirements are resolved.
...
Journal portals and wording can change. Re-open the official Wiley JBI Author Guidelines immediately before upload and verify the current portal-specific file designations, mandatory fields and data-repository workflow.
