...
Scope fixed before public-source retrieval: *Campanula punctata* sensu lato, Japan, 2023-01-01 through 2025-12-31. The YAMAP frame comprised every record returned by a predefined Japanese focal-name keyword set, including “ホタルブクロ”; the retrieved candidates were not subsampled by year or region before author screening. Public comparators required an image and a georeference. Counts are descriptive of this focal taxon/time window only.
...
| Taxonomic/subject validation used here | Every keyword-retrieved candidate visually screened by the study author; misidentified, similar campanuloid and non-focal flower subjects removed before the screened source table was finalized | Community identification; 472/516 Research Grade | Provider-dependent; 389/393 records inherited from iNaturalist |
...
| Duplicate/image identity audit | SHA-256 hashes identified exact-image copies; identical-coordinate records were cross-checked using photograph, date and activity provenance as potential repeated observations; coordinate identity alone was not an exclusion rule | not part of the matched count benchmark | provider-dependent; syndicated records possible |
...
The benchmark does not assign one global quality score. iNaturalist has a strong native community-identification/Research-Grade system. YAMAP's advantage for this study arises from a different observation process plus a study-specific quality layer: exhaustive review of the full keyword-retrieved candidate pool, taxon/subject/petal-ROI validation, exact-image and identical-coordinate audit, and deterministic quantitative phenotyping. This author screening reduces misidentification and repeated-observation error but does not turn route-linked photographs into an areally random survey. The mountain-route frame is advantageous for sampling the natural geographical context of the focal wild herb but can compress the urban-rural gradient used in the later human-context analysis.
