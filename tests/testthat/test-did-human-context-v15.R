source(testthat::test_path("../../scripts/mlit_human_forest_edge.R"))
source(testthat::test_path("../../scripts/extreme_human_diagnostic_v11.R"))
source(testthat::test_path("../../scripts/human_landscape_extremes_v12.R"))
source(testthat::test_path("../../scripts/local_human_neighbourhood_v14.R"))
source(testthat::test_path("../../scripts/did_human_context_v15.R"))
